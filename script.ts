...
let genBtn = document.querySelector('.generate') as HTMLDivElement

genBtn.addEventListener('click', () => {
	let affirmText = document.querySelector('.affirmations') as HTMLDivElement
	let container = document.querySelector('.inner-container') as HTMLDivElement
	let headingBtn = document.querySelector('.heading') as HTMLHeadingElement
